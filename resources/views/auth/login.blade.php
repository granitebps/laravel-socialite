                        ...
                        <div class="form-group row mb-0">
                            ...
                            <div class="col-md-4">
                                <a href="{{url('/auth/line')}}" class="btn btn-dark mb-1">
                                    <i class="fab fa-line"></i> Login With Line
                                </a>
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                <a href="{{url('/auth/bitbucket')}}" class="btn btn-dark mb-1">
                                    <i class="fab fa-bitbucket"></i> Login With Bitbucket
                                </a>
                            </div>
                            <div class="col-md-4">
                                <a href="{{url('/auth/digitalocean')}}" class="btn btn-dark mb-1">
                                    <i class="fab fa-digital-ocean"></i> Login With DigitalOcean
                                </a>
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                <a href="{{url('/auth/dropbox')}}" class="btn btn-dark mb-1">
                                    <i class="fab fa-dropbox"></i> Login With Dropbox
                                </a>
                            </div>
                        </div>
                    </form>
